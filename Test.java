public class Test {
	...
	public static void main(String[] args) {
		try {
			...
			// String urlStr = null;
			// String requestData="{\"tracking_number\":\"RS221832279DE\"}";
			...
			// String	urlStr ="?page=1&limit=100&created_at_min=0&created_at_max=0&update_time_min=0&update_time_max=0&order_created_time_min=0&order_created_time_max=0&numbers=RS221832279DE&orders=&lang=cn";
			// String requestData=null;
			// String result = new Tracker().orderOnlineByJson(requestData,urlStr,"get");
			// System.out.println("result======="+result);

			// 5 Get tracking results of a single tracking.
			// String	urlStr ="/pfcexpress/RS221832279DE/en";
			// String requestData=null;
			...
			// String	urlStr ="/pfcexpress/RS221832279DE";
			...
			// String	urlStr =null;
			// String requestData="{\"tracking_number\": \"RS221832279DE\",\"carrier_code\":\"pfcexpress\",\"destination_code\":\"US\",\"tracking_ship_date\": \"20180908\",\"tracking_postal_code\":\"12201\",\"specialNumberDestination\":\"UK\",\"order\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"lang\":\"en\"}";
			// String result = new Tracker().orderOnlineByJson(requestData,urlStr,"realtime");
			// System.out.println("result======="+result);

			// 10 Modify courier code
			// String	urlStr =null;
			// String requestData="{\"tracking_number\": \"RS221832279DE\",\"carrier_code\":\"pfcexpress\",\"update_carrier_code\":\"china-ems\"}";
			...
			// String	urlStr =null;
			// String requestData= "[{\"tracking_number\":\"RS221832279DE\",\"carrier_code\":\"pfcexpress\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"china-ems\"}]";
			...
			// String	urlStr =null;
			// String requestData= "[{\"carrier_code\":\"pfcexpress\",\"destination\":\"US\",\"original\":\"CN\"},{\"carrier_code\":\"china-ems\",\"destination\":\"US\",\"original\":\"CN\"}]";
